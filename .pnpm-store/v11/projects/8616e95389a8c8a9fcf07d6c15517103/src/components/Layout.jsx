...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      { to: "/workflow/student-handoff", label: "1 · Onboarding", icon: UserPlus },
...
const ROLE_PATHS = {
  academic_coordinator: new Set(["/faculty", "/monitoring-sheet", "/curriculum-planning", "/course-adjustments", "/workflow/student-handoff", "/workflow/course-audit", "/workflow/research-gate", "/workflow/panel-matching", "/workflow/practicum", "/workflow/graduation", "/workflow/withdrawal", "/workflow/awol", "/work-queue"]),
  research_coordinator: new Set(["/curriculum-planning", "/course-adjustments", "/workflow/research-gate", "/workflow/graduation", "/work-queue"]),
};
