...
export default function Enrollment() {
  ...
  const manualOptions = (data?.curriculum_subjects || []).filter(
    (course) => !offeredIds.has(course.id) && !selected.has(course.id)
  );
              ...
              <Card className="p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                      Add a curriculum subject that is not on the official offering list. The
                      conflict preview will require a documented decision before saving.
                    </p>
