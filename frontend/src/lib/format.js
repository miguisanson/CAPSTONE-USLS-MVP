...
const STATUS_STYLES = {
  ...
  "Approved - Awaiting Subject Tag": "bg-amber-50 text-amber-700 ring-amber-200",
  "Approved - Registrar Preparation": "bg-blue-50 text-blue-700 ring-blue-200",
  "Subject Tagged - Registrar Preparation": "bg-brand-50 text-brand-700 ring-brand-200",
  "Pending Subject Tag": "bg-amber-50 text-amber-700 ring-amber-200",
