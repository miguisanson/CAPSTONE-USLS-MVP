...
const ROLE_PATHS = {
  academic_coordinator: new Set(["/monitoring-sheet", "/workflow/course-audit", "/workflow/research-gate", "/workflow/practicum", "/workflow/graduation", "/workflow/withdrawal", "/work-queue"]),
