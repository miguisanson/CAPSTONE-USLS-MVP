...
const sectionTitleByPath: Array<{ match: RegExp; title: string }> = [
  ...
  { match: /^\/transactions/, title: "Transaction Workbench" },
  ...
  const items = useMemo<NavItem[]>(
    () => [
      ...
      },
      {
        to: "/transactions",
        label: "Transactions",
        description: "Transaction-list workflows grouped by lifecycle, coursework, research gates, scheduling, completion, and follow-up.",
